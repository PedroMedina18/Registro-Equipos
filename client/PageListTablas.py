...
class PageListTablas():
    ...
    def lista_tablas(self):
        ...
        self.tabla = ttk.Treeview(self.framePrincipal, columns=("Nombre", "Descripcion"), height=30)
        ...
        self.boton_buscar.config(width=20, font=FONT_LABEL, fg="white", bg=COLOR_AZUL, cursor="hand2", activebackground=ACTIVE_AZUL, command=self.buscarDataTabla)
    ...
    def frameTableData(self, id_table=0, name_tabla=""):
        ...
        buttonRegresar.config(width=15, font=FONT_LABEL, fg="white", bg=COLOR_VERDE, cursor="hand2", activebackground=ACTIVE_VERDE, command=self.regresar)
        ...
        for campos in list_campos:
            ...
            if campos[2]>150:
                ...
                entry_nombre.grid(row=2+self.CONTADOR, column=1, padx=10, pady=10, columnspan=2)
    ...
    def tabla_lista(self):
        ...
        tabla = ttk.Treeview(self.framePrincipal, columns=columns, height=20)
        tabla.grid(row=3+self.CONTADOR, column=0, columnspan=4, sticky="NSEW")

        # Scroll bar
        scroll=ttk.Scrollbar(self.framePrincipal, orient="vertical", command=tabla.yview)
        ...
        self.boton_editar.config(width=20, font=FONT_LABEL, fg="white", bg=COLOR_AZUL, cursor="hand2", activebackground=ACTIVE_AZUL)
        ...
        self.boton_eliminar.config(width=20, font=FONT_LABEL, fg="white", bg=COLOR_ROJO, cursor="hand2", activebackground=ACTIVE_ROJO)
